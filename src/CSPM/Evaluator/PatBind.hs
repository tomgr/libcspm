...
instance Bindable Pat where
	...
	bind (PConcat p1 p2) (VList xs) = error "PConcat not implemented"
	bind (PDotApp p1 p2) v = error "PDotApp not implemented"
	...
	bind (PSet [p]) (VSet s) = error "PSet not implemented"
